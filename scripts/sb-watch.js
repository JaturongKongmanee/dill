...
function _processFile(filePath, watchEvent) {
    ...
    if (!READY) {
        if (filePath.match(/\.pug$/)) {
            if (!filePath.match(/sections/) && !filePath.match(/mixins/) && !filePath.match(/\/pug\/layouts\//)) {
...
function _handlePug(filePath, watchEvent) {
    if (watchEvent === 'change') {
        if (filePath.match(/sections/) || filePath.match(/plugins/) || filePath.match(/mixins/) || filePath.match(/\/pug\/layouts\//)) {
